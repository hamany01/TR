...
exports.triggerSchedulerManual = exports.runReminderScheduler = void 0;
 ...
 */
exports.runReminderScheduler = functions.pubsub
                    ...
                    for (const ch of channels) {
                        ...
                        if (ch === "telegram") {
                            if (userProfile.telegramChatId && userProfile.channelsConfig?.telegram === true) {
                                try {
                                    const success = await (0, telegram_1.sendTelegramReminder)(userProfile, eventData, rule, eventId);
                                    if (success) {
                                        realSent = true;
                                    }
                                    else {
 ...
 */
exports.triggerSchedulerManual = functions.https.onRequest(async (req, res) => {
